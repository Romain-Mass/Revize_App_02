...
const quizsParDefaut = [
...

  {
    ...
    questions: [
      {
        id: 1,
        question: "Quel est le rôle principal d'un enseignant ?",
        reponses: [
          'Accompagner les élèves dans leurs apprentissages',
          'Créer uniquement des sites web',
          'Gérer uniquement les ordinateurs',
        ],
        bonneReponse: 0,
        explication:
          'Un enseignant accompagne les élèves dans leurs apprentissages.',
      },
    ],
  },
